...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference("Table.count") do
      post tables_url, params: { table: { name: @table.name, owner-id: @table.owner-id, status: @table.status } }, as: :json
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { name: @table.name, owner-id: @table.owner-id, status: @table.status } }, as: :json
    assert_response :success
  end
